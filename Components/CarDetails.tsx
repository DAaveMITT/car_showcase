              ...
              >
                ...
                <Dialog.Panel className='relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex flex-col gap-5'>
                  ...
                  <div className='flex-1 flex flex-col gap-3'>
                    ...
                    {/* three additional images appearing in the pop-up modal  */}
                  ...
                  <div className='flex-1 flex flex-col gap-2'>
                    ...
                    {/* Car properties listed inside the pop-up modal */}
                    <div className='mt-3 flex flex-wrap gap-4'>

                     {/* Key = items appearing on the left side of the modal  */}
                     {/* Value = the value of the key. the value is what appears on the right side of the modal  */}
